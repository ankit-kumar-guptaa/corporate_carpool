...
@Directive({
    selector: '[specialIsNumericPoint]',
    providers: [{
        provide: NG_VALUE_ACCESSOR,
        useExisting: forwardRef(() => SpecialCharacterPointDirective),
        multi: true
    }]
})
export class SpecialCharacterPointDirective  implements ControlValueAccessor {


    
    regexStr = '^[0-9.]*$';
   //regexStr='/^([1-9]|[1-5][0-9]|60(\.0{1,2})?$)(\.[0-9]{1,2})?$/'
